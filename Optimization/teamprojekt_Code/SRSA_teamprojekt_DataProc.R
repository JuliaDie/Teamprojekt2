...
if(procType == 1) {
write.csv(llWorkers12, "teamprojekt_Data/teamprojekt_KLDivs_simpleRSA_indOpt_iterative.csv")
write.csv(paramsWorkers12, "teamprojekt_Data/teamprojekt_Params_simpleRSA_indOpt_iterative.csv")
} else {
