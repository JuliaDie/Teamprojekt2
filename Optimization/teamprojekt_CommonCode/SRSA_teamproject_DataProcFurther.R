...
if(iterative12 == 1) {
  paramsWorkers12 <- as.matrix(read.csv("teamproject_Data/x9Params_simpleRSA_indOpt_iterative.csv"))
  llWorkers12 <- as.matrix(read.csv("teamproject_Data/x9KLDivs_simpleRSA_indOpt_iterative.csv"))
}else {
...
if(iterative12 == 1) {
  if(parSetting == 1) {
    write.csv(x9data, "teamproject_Data/Augm_SRSAindOpt_fixed00_andOpt12_iterative.csv")
  }else if(parSetting == 2) {
    write.csv(x9data, "teamproject_Data/Augm_SRSAglobalOpt_fixed10_andOpt12_iterative.csv")
  }
}else if(iterative12 == 2) {
  if(parSetting == 1) {
