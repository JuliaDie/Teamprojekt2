source("teamprojekt_CommonCode/RSA_StratUtt.R")
...
x9data <- read.csv("teamprojekt_Data/teamprojekt_dataAugm_SRSAindOpt_fixed00_andOpt12_iterative.csv")
#x9data <- read.csv("teamproject_Data/Augm_SRSAglobalOpt_fixed10_andOpt12_iterative.csv")
